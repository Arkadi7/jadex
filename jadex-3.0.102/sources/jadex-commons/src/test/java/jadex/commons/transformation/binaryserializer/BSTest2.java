 ...
 */
public class BSTest2 extends jadex.commons.transformation.Test
{
	...
	public Object doWrite(Object wo)
	{
		...
		SBinarySerializer2.writeObjectToStream(baos, wo, null);
	...
	public Object doRead(Object ro) 
	{
		...
		return SBinarySerializer2.readObjectFromStream(bais, null, null, null, null);
	}
...
//		byte[] serialized = SBinarySerializer2.objectToByteArray(oute, null, null, null);
	...
	public void testUnknownSubobjectClass() throws Exception
	{
		...
		Object out = SBinarySerializer2.readObjectFromStream(bais, null, null, dcl, new IErrorReporter()
		{
